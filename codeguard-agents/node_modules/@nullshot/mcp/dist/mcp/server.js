 ...
 */
export class McpServerDO extends DurableObject {
    constructor(ctx, env, server) {
        super(ctx, env);
     ...
     */
    processWebSocketConnection(request) {
